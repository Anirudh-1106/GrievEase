...
// Update to use correct path for admin SDK
...
app.post('/complaints', async (req, res) => {
  ...
  try {
    ...
    const adminNotification = new Notification({
      ...
      message: `New complaint submitted: ${complaintId} - "${req.body.title}"`,
...
app.post('/complaints/update/:complaintId', async (req, res) => {
  try {
    ...
    // Send notification
    await admin.messaging().send({
      topic: `user_${complaint.userName}`,
      notification: {
